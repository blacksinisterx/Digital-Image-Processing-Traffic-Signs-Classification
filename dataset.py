...
# Read the CSV files
meta_df = pd.read_csv(os.path.join("E:/FAST'22BS-AI/Semester6/Digital Image Processing (DIP)/DIP_Project/archive/Meta.csv"))
train_df = pd.read_csv(os.path.join ("E:/FAST'22BS-AI/Semester6/Digital Image Processing (DIP)/DIP_Project/archive/Train.csv"))
test_df = pd.read_csv(os.path.join( "E:/FAST'22BS-AI/Semester6/Digital Image Processing (DIP)/DIP_Project/archive/Test.csv"))
